            ...
            <div class="page-content">
                ...
                <div class="content-frame">                                    
                    ...
                    <div class="content-frame-body content-frame-body-left">
                        ...
                        <form id="form_msg" action="{{url('chat/msg')}}" method="POST">
                        <div class="panel panel-default push-up-10">
                            <div class="panel-body panel-body-search">
                                <div class="input-group">
                                    ...
                                    <input name="name" type="text" class="form-control" placeholder="Seu Nick"/>
                                    <input name="message" type="text" class="form-control" placeholder="Sua Mensagem..."/>
                                    <div class="input-group-btn">
                                        <button id="enviar_msg" class="btn btn-default">Enviar</button>
                                    </div>                                    
                                </div>
                            </div>
                        </div>
    ...
    <!-- START SCRIPTS -->
        ...
        <script type="text/javascript">
            if(typeof(EventSource) !== "undefined") {
                var source = new EventSource("{{url('chat/stream')}}");
                source.onmessage = function(event) 
                {
                    ...
                    $.each( json, function( key, value ) {
                        ...
                        var html =    '<div class="item item-visible">'
                                        + '<div class="image">'
                                            + '<img src="assets/images/users/user.jpg" alt="Dmitry Ivaniuk">'
                                        + '</div>'
                                        + '<div class="text">'
